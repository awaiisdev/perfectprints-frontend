            ...
            <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
                ...
                >
                    <h2 className="text-3xl md:text-5xl font-semibold text-gray-900 tracking-tight mb-4">
                        Custom Printing & Personalized Gifts Pakistan
                    </h2>
                    <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed">
                        Pakistan ka #1 Custom Printing Store — Mugs, T-Shirts, Keychains & Corporate Gifts. <br className="hidden md:block" />
                        Lahore se poore Pakistan delivery. Order karo aur 2-3 din mein ghar pe payein!.
                    </p>
                </motion.div>
